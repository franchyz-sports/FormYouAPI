...
class FormationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create formation" do
    assert_difference('Formation.count') do
      post formations_url, params: { formation: { description: @formation.description, title: @formation.title } }, as: :json
    end
  ...
  test "should update formation" do
    patch formation_url(@formation), params: { formation: { description: @formation.description, title: @formation.title } }, as: :json
    assert_response 200
  end
